...
function Export-ScriptToExe
{
<#
    .SYNOPSIS
        Builds a standalone executable for this script.

    .PARAMETER OutputPath
        Destination path for the generated executable.

    .NOTES
        Requires the 'ps2exe' PowerShell module.
#>
        param([string]$OutputPath = (Join-Path $ScriptDirectory 'ScriptArcade.exe'))
        ...
        if (-not (Get-Module -ListAvailable -Name ps2exe))
        {
                ...
                {
                        Write-Error "ps2exe module is required and could not be installed: $_"
                        return
                }
        }
        ...
        try
        {
                ...
                Invoke-PS2EXE -InputFile $scriptPath -OutputFile $OutputPath -NoConsole -ErrorAction Stop
...
function Show-pazwh_psf
{
	...
	function Get-RemoteGitScripts
	{
		...
		foreach ($item in $typedList)
		{
			...
			$addNewScript = $scriptsAround.Content | ConvertFrom-Json
...
function Export-ScriptAsExecutable
{
        param(
        ...
        {
                Write-Warning 'ps2exe module is required. Install it with Install-Module -Name ps2exe.'
                return
        }

        & (Get-Command ps2exe.ps1).Source $ScriptPath $OutputPath
}
#endregion
	...
	$btn_executionPrepare_Click = {
		...
		#
                ...
                $ConstructForm.Controls.Add($script:logbox)
		...
		# buttondebug
		#
		$buttonExportLogs.Location = New-Object System.Drawing.Point(29, 600)
		$buttonExportLogs.Name = 'buttonDebug'
		$buttonExportLogs.Size = New-Object System.Drawing.Size(87, 32)
		$buttonExportLogs.TabIndex = 5
		$buttonExportLogs.Text = 'debugSTart'
		$buttonExportLogs.UseVisualStyleBackColor = $True
		$buttonExportLogs.add_Click($buttonExportLogs_Click)
		...
		#
                # logbox
                #
                $script:logbox.Location = New-Object System.Drawing.Point(79, 436)
                $script:logbox.Name = 'logbox'
                $script:logbox.Size = New-Object System.Drawing.Size(689, 208)
                $script:logbox.TabIndex = 3
                $script:logbox.Text = ''
		#
		# panel1
		#
	...
	$buttonReviewScript_Click={
        ...
        $buttonExportForLocalExecut_Click={
                Export-ScriptToExe
                $dialog = New-Object System.Windows.Forms.SaveFileDialog
                $dialog.Filter = 'Executable (*.exe)|*.exe'
                $dialog.FileName = 'ScriptArcade.exe'
                if ($dialog.ShowDialog() -eq [System.Windows.Forms.DialogResult]::OK)
                {
                        Export-ScriptAsExecutable -OutputPath $dialog.FileName
                }
        }
	...
	$Form_StateCorrection_Load=
	{
		...
		$formScriptExecutionArcad.WindowState = $InitialFormWindowState
	}
	
	$Form_StoreValues_Closing=
	{
		#Store the control values
		$script:pazwh_textbox1 = $textbox1.Text
		$script:pazwh_rtb_selection = $rtb_selection.Text
		$script:pazwh_scriptsAvail = $scriptsAvail.SelectedItems
	}
	...
	$formScriptExecutionArcad.Controls.Add($menustripTheme)
	...
	$buttonExportForLocalExecut.Size = New-Object System.Drawing.Size(160, 68)
        ...
        $buttonExportForLocalExecut.add_Click($buttonExportForLocalExecut_Click)

        #
        # button1
	#
	$button1.Location = New-Object System.Drawing.Point(856, 609)
	$button1.Name = 'button1'
	$button1.Size = New-Object System.Drawing.Size(91, 29)
	$button1.TabIndex = 27
	...
	[void]$menustripTheme.Items.Add($toolstripmenuitem1)
	[void]$menustripTheme.Items.Add($toolstriptextbox1)
	...
	$menustripTheme.Size = New-Object System.Drawing.Size(951, 27)
	...
	$toolstripmenuitem1.Size = New-Object System.Drawing.Size(124, 23)
	...
	$toolstriptextbox1.Size = New-Object System.Drawing.Size(100, 23)
	...
	$formScriptExecutionArcad.ResumeLayout()
...
#region Source: PrepareScript.psf
function Show-PrepareScript_psf
{
	#----------------------------------------------
	#region Import the Assemblies
	#----------------------------------------------
	...
	$formPrepareScript_Load={
		#TODO: Initialize Form Controls here
		$buildThis = $script:selectedFull
		$i=0
		<#
		foreach ($item in $buildThis.Inputs)
		{
	
			$thisVariable = 'label' + $i
			Set-Variable -Name $thisVariable -Value $item.label
			$thisVariable = New-Object 'System.Windows.Forms.Label'
			$thisVariable.Name = $item.name
			$thisVariable.Autosize = $true
			$thisVariable.Font = [System.Drawing.Font]::new('Tahoma', '26.25', [System.Drawing.FontStyle]'Bold')
			$thisVariable.Text = $thisVariable.label
			$thisVariable.Location = New-Object System.Drawing.Point(($i * 15), 35)
			$ConstructForm.Controls.add($thisVariable)
			
			$thisVariable2 = 'TextBox' + $i
			Set-Variable -Name $thisVariable -Value $item.Name
			$thisVariable2 = New-Object 'System.Windows.Forms.Textbox'
			$thisVariable2.Location = New-Object System.Drawing.Point(($i * 15), 65)
			$thisVariable2.Name = $item.name
			$thisVariable2.AutoSize = $true
			$thisVariable2.Text = $item.Name
...
$script:logbox.Clear()
        ...
        try {
                ...
                if ($executionResults) {
                        if ($executionResults -is [System.Collections.IEnumerable] -and -not ($executionResults -is [string])) {
                                foreach ($line in $executionResults) {
                                        $script:logbox.AppendText($line.ToString() + "`n")
                                        Add-Content -Path $logFile -Value $line
                                }
                        } else {
                                $script:logbox.AppendText($executionResults.ToString() + "`n")
                ...
                $script:logbox.AppendText($_.Exception.Message + "`n")
...
$button1_Click={
 	...
 	{
 		#Store the control values
                $script:PrepareScript_logbox = $script:logbox.Text
 	}
